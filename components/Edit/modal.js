...
async function EditModal(interaction) {
        const modal = new ModalBuilder().setCustomId("editmodal").setTitle("Edit Domain");
        ...
        const firstActionRow = new ActionRowBuilder().addComponents(improvements);
        const secondActionRow = new ActionRowBuilder().addComponents(suggestions);
